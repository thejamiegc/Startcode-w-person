...
- dobbelclick the new table and change firstname and add columns (remember to add a check mark in 'ai' for the primary key)
...
- Right click project firstname -> new -> persistence -> Entity classes From Database -> choose database connection from list -> add the tables you need -> Finish
